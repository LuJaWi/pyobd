...
class Commands():
    ...
    # Mode 2 - Freeze Frame (DTC_ prefixed versions of Mode 1)
    DTC_PIDS_A: OBDCommand
    DTC_STATUS: OBDCommand
    DTC_FREEZE_DTC: OBDCommand
    DTC_FUEL_STATUS: OBDCommand
    DTC_ENGINE_LOAD: OBDCommand
    DTC_COOLANT_TEMP: OBDCommand
    DTC_SHORT_FUEL_TRIM_1: OBDCommand
    DTC_LONG_FUEL_TRIM_1: OBDCommand
    DTC_SHORT_FUEL_TRIM_2: OBDCommand
    DTC_LONG_FUEL_TRIM_2: OBDCommand
    DTC_FUEL_PRESSURE: OBDCommand
    DTC_INTAKE_PRESSURE: OBDCommand
    DTC_RPM: OBDCommand
    DTC_SPEED: OBDCommand
    DTC_TIMING_ADVANCE: OBDCommand
    DTC_INTAKE_TEMP: OBDCommand
    DTC_MAF: OBDCommand
    DTC_THROTTLE_POS: OBDCommand
    DTC_AIR_STATUS: OBDCommand
    DTC_O2_SENSORS: OBDCommand
    DTC_O2_B1S1: OBDCommand
    DTC_O2_B1S2: OBDCommand
    DTC_O2_B1S3: OBDCommand
    DTC_O2_B1S4: OBDCommand
    DTC_O2_B2S1: OBDCommand
    DTC_O2_B2S2: OBDCommand
    DTC_O2_B2S3: OBDCommand
    DTC_O2_B2S4: OBDCommand
    DTC_OBD_COMPLIANCE: OBDCommand
    DTC_O2_SENSORS_ALT: OBDCommand
    DTC_AUX_INPUT_STATUS: OBDCommand
    DTC_RUN_TIME: OBDCommand
    DTC_PIDS_B: OBDCommand
    DTC_DISTANCE_W_MIL: OBDCommand
    DTC_FUEL_RAIL_PRESSURE_VAC: OBDCommand
    DTC_FUEL_RAIL_PRESSURE_DIRECT: OBDCommand
    DTC_O2_S1_WR_VOLTAGE: OBDCommand
    DTC_O2_S2_WR_VOLTAGE: OBDCommand
    DTC_O2_S3_WR_VOLTAGE: OBDCommand
    DTC_O2_S4_WR_VOLTAGE: OBDCommand
    DTC_O2_S5_WR_VOLTAGE: OBDCommand
    DTC_O2_S6_WR_VOLTAGE: OBDCommand
    DTC_O2_S7_WR_VOLTAGE: OBDCommand
    DTC_O2_S8_WR_VOLTAGE: OBDCommand
    DTC_COMMANDED_EGR: OBDCommand
    DTC_EGR_ERROR: OBDCommand
    DTC_EVAPORATIVE_PURGE: OBDCommand
    DTC_FUEL_LEVEL: OBDCommand
    DTC_WARMUPS_SINCE_DTC_CLEAR: OBDCommand
    DTC_DISTANCE_SINCE_DTC_CLEAR: OBDCommand
    DTC_EVAP_VAPOR_PRESSURE: OBDCommand
    DTC_BAROMETRIC_PRESSURE: OBDCommand
    DTC_O2_S1_WR_CURRENT: OBDCommand
    DTC_O2_S2_WR_CURRENT: OBDCommand
    DTC_O2_S3_WR_CURRENT: OBDCommand
    DTC_O2_S4_WR_CURRENT: OBDCommand
    DTC_O2_S5_WR_CURRENT: OBDCommand
    DTC_O2_S6_WR_CURRENT: OBDCommand
    DTC_O2_S7_WR_CURRENT: OBDCommand
    DTC_O2_S8_WR_CURRENT: OBDCommand
    DTC_CATALYST_TEMP_B1S1: OBDCommand
    DTC_CATALYST_TEMP_B2S1: OBDCommand
    DTC_CATALYST_TEMP_B1S2: OBDCommand
    DTC_CATALYST_TEMP_B2S2: OBDCommand
    DTC_PIDS_C: OBDCommand
    DTC_STATUS_DRIVE_CYCLE: OBDCommand
    DTC_CONTROL_MODULE_VOLTAGE: OBDCommand
    DTC_ABSOLUTE_LOAD: OBDCommand
    DTC_COMMANDED_EQUIV_RATIO: OBDCommand
    DTC_RELATIVE_THROTTLE_POS: OBDCommand
    DTC_AMBIANT_AIR_TEMP: OBDCommand
    DTC_THROTTLE_POS_B: OBDCommand
    DTC_THROTTLE_POS_C: OBDCommand
    DTC_ACCELERATOR_POS_D: OBDCommand
    DTC_ACCELERATOR_POS_E: OBDCommand
    DTC_ACCELERATOR_POS_F: OBDCommand
    DTC_THROTTLE_ACTUATOR: OBDCommand
    DTC_RUN_TIME_MIL: OBDCommand
    DTC_TIME_SINCE_DTC_CLEARED: OBDCommand
    DTC_MAX_VALUES: OBDCommand
    DTC_MAX_MAF: OBDCommand
    DTC_FUEL_TYPE: OBDCommand
    DTC_ETHANOL_PERCENT: OBDCommand
    DTC_EVAP_VAPOR_PRESSURE_ABS: OBDCommand
    DTC_EVAP_VAPOR_PRESSURE_ALT: OBDCommand
    DTC_SHORT_O2_TRIM_B1: OBDCommand
    DTC_LONG_O2_TRIM_B1: OBDCommand
    DTC_SHORT_O2_TRIM_B2: OBDCommand
    DTC_LONG_O2_TRIM_B2: OBDCommand
    DTC_FUEL_RAIL_PRESSURE_ABS: OBDCommand
    DTC_RELATIVE_ACCEL_POS: OBDCommand
    DTC_HYBRID_BATTERY_REMAINING: OBDCommand
    DTC_OIL_TEMP: OBDCommand
    DTC_FUEL_INJECT_TIMING: OBDCommand
    DTC_FUEL_RATE: OBDCommand
    DTC_EMISSION_REQ: OBDCommand
    
    # Mode 3 & 4 - DTCs
    GET_DTC: OBDCommand
    CLEAR_DTC: OBDCommand
    
    # Mode 6 - Test Results (Monitor IDs)
    MIDS_A: OBDCommand
    ...
    # Misc - ELM327 Commands
    ELM_VERSION: OBDCommand
    ELM_VOLTAGE: OBDCommand
    
    # Dynamic mode access
    modes: list[list[OBDCommand | None]]
