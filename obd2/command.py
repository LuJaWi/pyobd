"""
Module defining the OBDCommand class for OBD-II commands.

Handles command properties, decoding, and response processing.
"""
...
class OBDCommand:
    ...
    def __str__(self):
        if self.header != ECU_HEADERS.ENGINE:
