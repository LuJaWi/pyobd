...
from obd2.sensors import sensors
from obd2.utils.hex_tools import hex_to_int
    ...
    def __init__(self,portnum,_notify_window, baud, SERTIMEOUT,RECONNATTEMPTS, FAST):
        ...
        while counter < RECONNATTEMPTS:
            ...
            try:
                ...
                pass
            self.connection = obd.OBD(portstr=portnum, baudrate=baud, protocol=None, fast=FAST, timeout=_truncate(float(SERTIMEOUT),1), check_voltage=False, start_low_power=False)
